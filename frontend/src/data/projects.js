export const projectsData = [
  {
    ...
    shortDescription:
      "A full-stack, Git-like version control system with a web dashboard and CLI.",
    fullDescription:
      "Developed a full-stack, Git-like version control system with a web dashboard and CLI for simplified code management. Features include repository creation, file tracking, commit history, issue management, and secure cloud storage (AWS S3, MongoDB Atlas), built using React.js, Node.js/Express.js, and MongoDB.",
  ...
  },
  {
    ...
    shortDescription:
      "A full-stack video conferencing platform with real-time video and chat.",
    fullDescription:
      "Developed a full-stack video conferencing platform using React, Node.js, and MongoDB, enabling real-time peer-to-peer video and chat with WebRTC, PeerJS, and Socket.IO. Implemented secure JWT authentication and deployed the decoupled application to Vercel and Render.",
  ...
  },
  {
    ...
    metrics: {}, // You can add custom metrics here
    date: "2025-12-06", // Update with the correct date
  },
  {
    id: 4,
    title: "AISLE : Artificial Intelligence System for Learning & Expression",
    shortDescription:
      "A full-stack MERN AI chat application,",
    fullDescription:
      "Engineered a full-stack MERN AI chat application, deploying a stateless Node.js/Express RESTful API on Render and a responsive React/Vite frontend on Vercel. The system uses the OpenAI API for real-time conversational AI, with a custom MongoDB schema for persistent, multi-threaded chat history.",
    image: "/images/aisle.png", // Replace with your actual project image path
    technologies: [
      "React",
      "Node",
      "Express",
  ...
  },
  {
    ...
    links: {
      ...
      github:
        "https://github.com/amaanslyf/Sigma-5.0-MERN/tree/main/MAJORPROJECT",
    },
    metrics: {},
    date: "2025-06-30",
  },
  {
    ...
    shortDescription:
      "A cutting-edge solution to streamline operations for the scrap dealing industry.",
    fullDescription:
      "The 'Scrap Dealer' web application is a cutting-edge solution designed to revolutionize the scrap dealing industry by streamlining and modernizing operations for scrap dealers, recyclers, and their customers.",
...
export const experience = [
  {
    ...
    description:
      "Learned Python along with data science fundamentals and practical applications.",
  },
...
export const achievements = [
  {
    ...
    description:
      "Published in the International Journal of Advanced Research in Science, Communication and Technology (IJARSCT).",
    type: "research",
  },
  {
    title: "Published Research Paper - AI-Eye on Campus",
    description:
      "Published in the International Journal of Innovative Research in Science, Engineering and Technology (IJIRSCET) on detecting smoking via CCTV.",
    type: "research",
  },
  {
    title: "Registered Patent - Real-Time Crowd Insights",
    description:
      "A system for real-time crowd insights and prediction of crowd in local transport.",
    type: "patent",
  },
  {
    title: "Technical Competition Participant",
    description:
      "Participated in TECH TITANS 2024, TECHNOTHON 2024, and the Prabal national-level hackathon (GDG).",
    type: "competition",
  },
];
